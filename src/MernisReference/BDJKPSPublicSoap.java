...
public class BDJKPSPublicSoap
{
    ...
    public BDJKPSPublicSoap(){}

    public BDJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BDJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BDJExtendedSoapSerializationEnvelope envelope= new BDJExtendedSoapSerializationEnvelope(BDJExtendedSoapSerializationEnvelope.VER11);
