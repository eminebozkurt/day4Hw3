...
public class BDJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BDJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BDJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BDJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BDJDateTimeConverter dateTimeConverter = new BDJStandardDateTimeConverter();

    public BDJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BDJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BDJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BDJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BDJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BDJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
